...
about:
  Reascript action for finding next variation in audio item.
  Uses built-in transient detection, which can be configured under action "Transient detection sensitivity/threshold: Adjust..." 
